...
ActiveRecord::Schema.define(version: 2023_04_06_081922) do
  ...
  create_table "addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "municapality", null: false
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "double_byte_first_name", null: false
    t.string "double_byte_last_name", null: false
    t.string "double_byte_first_name_kana", null: false
    t.string "double_byte_last_name_kana", null: false
